...
func newNotifySocket(root string, notifySocketHost string) *notifySocket {
	if notifySocketHost == "" {
		return nil
	}
...
func notifySocketStart(root string, notifySocketHost string) (*notifySocket, error) {
	notifySocket := newNotifySocket(root, notifySocketHost)
	if notifySocket == nil {
		return nil, nil
	}
