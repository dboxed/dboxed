...
func (c *S3ProxyClient) S3ProxyListObjects(ctx context.Context, s3BucketId string, req models.S3ProxyListObjectsRequest) (*models.S3ProxyListObjectsResult, error) {
...
func (c *S3ProxyClient) S3ProxyPresignPut(ctx context.Context, s3BucketId string, req models.S3ProxyPresignPutRequest) (*models.S3ProxyPresignPutResult, error) {
...
func (c *S3ProxyClient) S3ProxyRenameObject(ctx context.Context, s3BucketId string, req models.S3ProxyRenameObjectRequest) (*models.S3ProxyRenameObjectResult, error) {
...
func (c *S3ProxyClient) S3ProxyDeleteObject(ctx context.Context, s3BucketId string, req models.S3ProxyDeleteObjectRequest) (*models.S3ProxyDeleteObjectResult, error) {
