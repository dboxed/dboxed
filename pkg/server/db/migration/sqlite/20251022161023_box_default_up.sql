...
INSERT INTO `new_box` (`id`, `workspace_id`, `created_at`, `deleted_at`, `finalizers`, `reconcile_status`, `reconcile_status_details`, `uuid`, `name`, `network_id`, `network_type`, `dboxed_version`, `machine_id`, `desired_state`) SELECT `id`, `workspace_id`, `created_at`, `deleted_at`, `finalizers`, `reconcile_status`, `reconcile_status_details`, `uuid`, `name`, `network_id`, `network_type`, `dboxed_version`, `machine_id`, IFNULL(`desired_state`, 'up') AS `desired_state` FROM `box`;
